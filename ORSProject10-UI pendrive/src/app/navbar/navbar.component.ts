...
export class NavbarComponent implements OnInit {
  ...
  constructor(private translate: TranslateService, private httpService: HttpServiceService, private servicelocator: ServiceLocatorService) {
  ...
  isLogin() {
    const check = localStorage.getItem('fname');
