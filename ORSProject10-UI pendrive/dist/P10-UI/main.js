    ...
    BaseListCtl.prototype.checklistUpdate = function () {
        ...
        this.checkboxes.forEach(function (element) {
            if (element.nativeElement.checked === true) {
                // console.log('ID:', element.nativeElement.id);
...
module.exports = __webpack_require__(/*! C:\Users\DELL\Desktop\project_10\gopal\ORSProject10-UI pendrive\src\main.ts */"./src/main.ts");
